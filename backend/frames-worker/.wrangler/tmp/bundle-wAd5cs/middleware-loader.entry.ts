...
import worker from "/home/pimania/dev/red-envelope-frames/backend/frames-worker/.wrangler/tmp/bundle-wAd5cs/middleware-insertion-facade.js";
import {
	__facade_invoke__,
	__facade_register__,
	Dispatcher,
	Middleware,
} from "/home/pimania/.nvm/versions/node/v18.19.0/lib/node_modules/wrangler/templates/middleware/common.ts";

// We need to preserve all of the exports from the worker
export * from "/home/pimania/dev/red-envelope-frames/backend/frames-worker/.wrangler/tmp/bundle-wAd5cs/middleware-insertion-facade.js";
